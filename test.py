...
logging.debug(f"KKK2")
token = '7530329365:AAF5lrcis8w50UJzpw_6mObl8nhTH3AlMOQ'
webhook_url = 'https://smart-eyes-glow.loca.lt'
web_port = '8080'
...
# main.py не будет выполнять __main__-блок, потому что Gunicorn просто импортирует app.
# Чтобы всё сработало:
